...
def apply_custom_styles():
    ...
    [data-testid="stSidebar"] .stWidgetLabel p { font-size: 10px !important; font-weight: 600 !important; margin-bottom: -15px !important; color: #4b5563; }
    [data-testid="stSidebar"] .stSelectbox div[data-baseweb="select"] > div { font-size: 11px !important; }
    [data-testid="stSidebar"] .stSlider div { font-size: 11px !important; }
