...
with tab1:
    ...
    with st.sidebar:
        ...
        finalidad = {
            ...
            "Finalidad",
            ["Auto", "Muebles", "Electrónicos", "Negocios",
             "Educación", "Reparaciones", "Otros"]
        )]
    ...
    if btn:
        ...
        with col_res:
            st.markdown(
                "<div class='titulo-secao'>Resultado</div><br><br>",
                unsafe_allow_html=True
            )
...
with tab3:
    ...
    status, cor = (
        ("ESTABLE", "#16a34a") if psi_val < 0.1
        else ("ALERTA", "#facc15") if psi_val < 0.25
