...
with tab1:
    ...
    if btn:
        ...
        with col_res:
            ...
            # Segmento centralizado + Pulo de linha solicitado
            st.markdown(f"<p style='text-align:center;font-size:18px;font-weight:700;color:#2563eb;'>{segmento}</p><br>", unsafe_allow_html=True)
            
            # Probabilidade centralizada + Pulo de linha solicitado
            st.markdown(f"<p style='text-align:center;margin-bottom:0;font-size:14px;font-weight:600;'>Probabilidad</p>", unsafe_allow_html=True)
            st.markdown(f"<p style='text-align:center;font-size:22px;font-weight:700;'>{prob:.2%}</p><br>", unsafe_allow_html=True)
            
            # Limite centralizado + Pulo de linha solicitado
            st.markdown(f"<p style='text-align:center;margin-bottom:0;font-size:14px;font-weight:600;'>Límite</p>", unsafe_allow_html=True)
            st.markdown(f"<p style='text-align:center;font-size:22px;font-weight:700;'>${limite:,.0f}</p><br>", unsafe_allow_html=True)
            
            # Status Final centralizado + Pulo de linha solicitado
